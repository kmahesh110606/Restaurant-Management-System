...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-8b7zw5cs-p$vox1_^=wgdti2wh74b*(5fm7*4@9rx&yn+y5xgi',
)
...
# ---------------------------------------------------------------------------
# Database — Postgres (falls back to SQLite if DB env vars unset)
# ---------------------------------------------------------------------------
...
if os.environ.get('DB_NAME'):
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'rms_db'),

...
echo "Running migrations..."  # Print status message indicating database migrations execution
python manage.py migrate --no-input  # Run Django database migrations automatically without prompting for user input

 ...
 * Pure JWT: login → fetch user/role/restaurant → route based on role.
 * Supports username/password login, Google OAuth, and restaurant signup.
 */
...
export function AuthProvider({ children }) {
  ...
  /**
   * Get the default dashboard path based on the user's role.
   */
